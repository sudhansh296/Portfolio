    ...
    <footer id="contact" style={styles.footer}>
      <div style={styles.inner}>
        <div style={styles.cta}>
          ...
          <a href="mailto:sudhanshuraj801302@gmail.com" style={styles.emailBtn}>Say Hello 👋</a>
        </div>
...
const styles = {
  footer: { background: 'var(--bg)', borderTop: '1px solid var(--border)', padding: '80px 40px 40px' },
  ...
  ctaHeading: { fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 900, marginBottom: '12px', letterSpacing: '-1px', color: 'var(--text)' },
  ctaSub: { color: 'var(--text3)', marginBottom: '28px', fontSize: '1rem' },
  emailBtn: {
  ...
  divider: { height: '1px', background: 'var(--border)', marginBottom: '32px' },
  bottom: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' },
  logo: { fontWeight: 800, color: 'var(--text2)', fontSize: '1rem' },
  socials: { display: 'flex', gap: '16px' },
  socialLink: { fontSize: '1.3rem', textDecoration: 'none', color: 'var(--text3)', transition: 'color 0.2s' },
  copy: { color: 'var(--text3)', fontSize: '0.85rem' }
};
